...
const translations: Record<Language, Translations> = {
  en: {
    ...
    help: {
      ...
      viberSub: "Fast response: 0992 631 2712",
      callClinic: "Call Clinic Hotline",
      bookMobileBar: "Book Appointment",
      orChatViber: "Prefer to chat? Message 0992 631 2712",
    ...
    expressBooking: {
      ...
      phonePlaceholder: "0992-631-2712",
      ...
      callNowBtn: "Call: 0992 631 2712",
      viberNowBtn: "Message: 0992 631 2712",
      ...
      errPhone: "Please enter a valid 11-digit mobile number (e.g. 0992-631-2712).",
    ...
    clinicInfo: {
      ...
      contactBarDirect: "Direct Line & SMS",
      ...
      faqs: [
        ...
        },
        {
          ...
          a: "To ensure dedicated care and zero waiting time, clinic visits are strictly by pre-scheduled appointment from Monday to Saturday (9:00 AM – 5:00 PM). Please message us on Facebook Messenger or send an SMS to 0992 631 2712.",
        },
        {
  ...
  fil: {
    ...
    help: {
      ...
      viberSub: "Mabilis sumagot: 0992 631 2712",
      callClinic: "Tawagan ang Klinika",
      bookMobileBar: "Mag-book ng Appointment",
      orChatViber: "Gusto mag-message? 0992 631 2712",
    ...
    expressBooking: {
      ...
      callNowBtn: "Tawag: 0992 631 2712",
      viberNowBtn: "Message: 0992 631 2712",
      ...
      errPhone: "Paki-lagay ang wastong 11-digit mobile number (Hal: 0992-631-2712).",
    ...
    clinicInfo: {
      ...
      contactBarDirect: "Direktang Linya at SMS",
      ...
      faqs: [
        ...
        },
        {
          ...
          a: "Bukas po ang aming klinika mula Lunes hanggang Sabado (9:00 AM – 5:00 PM) para sa mga pre-scheduled appointments lamang upang walang hintayan. Mag-message sa Facebook Messenger o mag-SMS sa 0992 631 2712.",
        },
        {
  ...
  ceb: {
    ...
    help: {
      ...
      viberSub: "Paspas motubag: 0992 631 2712",
      callClinic: "Tawag sa Hotline",
      bookMobileBar: "Mag-book og Appointment",
      orChatViber: "Gusto mag-chat? 0992 631 2712",
    ...
    expressBooking: {
      ...
      callNowBtn: "Tawag: 0992 631 2712",
      viberNowBtn: "Mensahe: 0992 631 2712",
      expressTab: "1-Step Quick Request",
      ...
      errPhone: "Palihug ibutang ang saktong 11-digit mobile number (Pananglitan: 0992-631-2712).",
    ...
    clinicInfo: {
      ...
      contactBarDirect: "Direktang Linya ug SMS",
      ...
      faqs: [
        ...
        },
        {
          ...
          a: "Abre kami gikan Lunes hangtod Sabado (9:00 AM – 5:00 PM) pinaagi lamang sa pre-scheduled appointments para walay paghulat. Palihog pag-mensahe sa Facebook Messenger o mag-SMS sa 0992 631 2712.",
        },
        {
